...
public class HibernateInstructorDao implements InstructorDao{
    ...
    public void add(Instructor instructor,ArrayList<Instructor> instructorList) {
        ...
        System.out.println(instructor.getFirstName()+" "+instructor.getLastName()+" ekleme tamamlandı: hibernate");
    }

    @Override
    public void delete(Instructor instructor,ArrayList<Instructor> instructorList) {
        instructorList.remove(instructor);
        System.out.println(instructor.getFirstName()+" "+instructor.getLastName()+"  silme tamamlandı: hibernate");
    }
